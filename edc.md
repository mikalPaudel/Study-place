...
#### **2.1.1 Operation of the npn Transistor in the Active Mode**  
...
#### **2.1.2 Graphical Representation of Transistor Characteristics**  
...
#### **2.1.3 Analysis of Transistor Circuits at DC**  
...
#### **2.1.4. Transistor as an Amplifier**  
...
#### **2.1.5 Small Signal Equivalent Circuit Models**  
...
#### **2.1.6. Graphical Load Line Analysis**  
...
#### **2.1.7 Biasing BJT for Discrete-Circuit Design**  
...
#### **2.1.8 Basic Single-Stage BJT Amplifier Configurations**  
- **Common Base (CB):** Low input impedance, high voltage gain.  
...
#### **2.1.9 Transistor as a Switch (Cutoff and Saturation Mode)**  
...
#### **2.1.10 A General Large-Signal Model for the BJT: The Ebers-Moll Model**  
...
### **3.1 Field-Effect Transistor (FET) - MOSFET**  
...
### **4.1 Output Stages and Power Amplifiers**  
...
### **5.1 Signal Generators & Waveform-Shaping Circuits**  
...
### **6.1 Power Supplies, Breakdown Diodes, and Voltage Regulators**  
